...
IF NOT EXISTS (SELECT 1 FROM dbo.usuario WHERE email = 'drauzio@sigep.com.br')
BEGIN
  INSERT INTO dbo.usuario (nome, cpf, email, senha_hash, administrador, senha_provisoria)
  VALUES (
    'Administrador',
    '00000000000',
    'drauzio@sigep.com.br',
  ...
  INSERT INTO dbo.usuario_perfil (id_usuario, id_perfil)
    ...
    WHERE dbo.usuario.email = 'drauzio@sigep.com.br'
      AND dbo.perfil.nome IN ('admin', 'aluno')

  PRINT 'Admin criado: drauzio@sigep.com.br / Admin@123'
END
ELSE
