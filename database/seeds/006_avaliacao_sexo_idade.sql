...
IF NOT EXISTS (SELECT 1 FROM dbo.avaliacao_fitness_pergunta WHERE codigo = 'sexo')
...
IF NOT EXISTS (SELECT 1 FROM dbo.avaliacao_fitness_pergunta WHERE codigo = 'idade')
  INSERT INTO dbo.avaliacao_fitness_pergunta (codigo, pergunta, tipo, obrigatorio, exibir_detalhe_sim, descricao_detalhe_sim, ordem) VALUES
...
IF NOT EXISTS (SELECT 1 FROM dbo.avaliacao_fitness_pergunta_opcao WHERE id_avaliacao_fitness_pergunta = @sexo AND valor = 'Masculino')
  INSERT INTO dbo.avaliacao_fitness_pergunta_opcao (id_avaliacao_fitness_pergunta, valor, ordem) VALUES (@sexo, 'Masculino', 1);

IF NOT EXISTS (SELECT 1 FROM dbo.avaliacao_fitness_pergunta_opcao WHERE id_avaliacao_fitness_pergunta = @sexo AND valor = 'Feminino')
  INSERT INTO dbo.avaliacao_fitness_pergunta_opcao (id_avaliacao_fitness_pergunta, valor, ordem) VALUES (@sexo, 'Feminino', 2);
